            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 text-center lg:text-left">
                ...
                <div>
                    <div className="flex items-center justify-center lg:justify-start mb-4">
                        <img src="src/assets/index_page_images/footer_images/address%20icon.png" alt="address" className="w-6 h-6" />
                    ...
                    <div className="flex items-center justify-center lg:justify-start mt-4">
                        <img src="src/assets/index_page_images/footer_images/phone%20no%20icon.png" alt="phone" className="w-6 h-6" />
                        <h3 className="text-2xl font-mono ml-2">Phone</h3>
                    </div>
                    <p className="text-lg font-mono">(+94)763533726</p>

                    <div className="flex items-center justify-center lg:justify-start mt-4">
                        <img src="src/assets/index_page_images/footer_images/email%20icon.png" alt="email" className="w-6 h-6" />
                ...
                <div>
                    ...
                    <div className="flex justify-center lg:justify-start space-x-4 mt-2">
                        <img src="src/assets/index_page_images/footer_images/whatsapp%20icon.png" alt="whatsapp" className="w-8 h-8" />
                        <img src="src/assets/index_page_images/footer_images/telegram%20icon.png" alt="telegram" className="w-8 h-8" />
                        <img src="src/assets/index_page_images/footer_images/facebook%20icon.png" alt="facebook" className="w-8 h-8" />
                    </div>
                </div>
            </div>
